          ...
          <div class="mt-4">
            ...
            <div class="mb-[65px] md:mb-[45px]">
              ...
              <div class="xl:pl-[12px] flex overflow-hidden rotate-180 scale-x-[-1] w-full mb-2">
                <div
                  v-for="(randomHeight, index) in heights"
                  :key="index"
              ...
              <div class="relative mt-2 mb-[15px]">
                ...
                <div
                  class="absolute bg-pink-500 h-1 rounded-full"
            ...
            <div class="pt-[15px] mb-6 border-t-[2px] border-gray-300 border-b-[2px] pb-[28px]">
              ...
              <div class="flex justify-between items-center mt-2">
                ...
                <div class="flex items-center">
                  <button
                    class="p-[6px] border rounded-full shadow-md text-gray-700 hover:text-black"
            ...
            <div v-if="isCategoryModalOpen" class="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center">
              <div class="bg-white w-[85vw] md:max-w-3xl h-[60vh] overflow-y-auto flex flex-col  no-scrollbar p-6 rounded-lg">
                <button @click="isCategoryModalOpen = false" class="text-[28px] ml-auto text-gray-700 hover:text-gray-400">
