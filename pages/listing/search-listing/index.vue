<template>
    <div class="min-h-screen bg-gray-50 lg:[pt-[150px] pt-[100px] xl:px-[75px] px-4">
        ...
        <div v-if="results.length === 0"
            class="mt-[150px] w-full flex flex-col mx-auto contrast justify-center items-center">
        ...
        <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 py-4">
            <div v-for="listing in results" :key="listing._id" @click="goToListing(listing._id)"
                class="overflow-hidden border rounded-xl bg-white cursor-pointer">
                <img :src="listing.images.placePicture || 'https://via.placeholder.com/300'" :alt="listing.name"
                    loading="lazy"
