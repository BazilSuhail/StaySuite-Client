    ...
    <main class="h-screen w-full pt-[75px] flex justify-center items-center bg-gray-100">
      <div class="flex flex-col w-[90%] md:w-[500px] md:scale-[1] scale-[0.9]">
        ...
        focusField === 'password' || formData.password ? '-top-5 text-sm' : 'top-2'
            ...
            <button type="submit" class="hover:text-blue-100 hover:bg-blue-950 w-full my-[15px] bg-gradient-to-r from-pink-800 via-rose-700 to-pink-800 rounded-lg text-white font-[500] py-[12px] transition duration-300">
              Sign Up
            </button>
          </form>
